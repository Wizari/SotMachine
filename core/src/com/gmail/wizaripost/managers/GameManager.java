...
public class GameManager {
    ...
    public void initialize(float width, float height) {
        ...
        spinLine2.initialize(width, height, -22.50f, 40, 2, 1,1,1);
        spinLine3 = new SpinLine();
        spinLine3.initialize(width, height, -30.00f, 50, 3, 1,1,1);
        spinLine4 = new SpinLine();
        spinLine4.initialize(width, height, -40.00f, 60, 4, 1,1,1);
        spinLine5 = new SpinLine();
        spinLine5.initialize(width, height, -49.00f, 75, 5, 1,1,1);
//        spinLine.initialize(width, height, -18.00f, 30, 1, 1,1,1);
//        spinLine2 = new SpinLine();
